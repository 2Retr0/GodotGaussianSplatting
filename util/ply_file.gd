...
static func load_gaussian_splats(point_cloud : PlyFile, device : RenderingDevice, buffer : RID, terminator:=func(): return false):
	var stride := point_cloud.num_vertices / 200
